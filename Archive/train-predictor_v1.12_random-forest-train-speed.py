...
def add_last_train_info_and_heading_average_optimized(toi2):
    ...
    toi3['last1_train_speed'] = toi3.groupby('train_id')['train_speed'].shift(1)  # Added
    ...
    toi3['last2_train_speed'] = toi3.groupby('train_id')['train_speed'].shift(2)  # Added
    ...
    toi3['last1_train_speed'].fillna(toi3['train_speed'], inplace=True)  # Added
    ...
    toi3['last2_train_speed'].fillna(toi3['train_speed'], inplace=True)  # Added
...
if model_train: # If the linear regression is to be trained by the data.
    ...
    X = toi7[['poi_dist', 'last1_poi_dist', 'last2_poi_dist','train_speed','last1_train_speed','last2_train_speed']]
