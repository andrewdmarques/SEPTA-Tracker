...
# Load the dataset
df = pd.read_csv('toi5.csv')

# Define the independent variable (X) and the dependent variable (y)
X = df[['poi_dist']]  # independent variable
y = df['time_to_poi']     # dependent variable
...
df['predicted_time_to_poi'] = model.predict(X)

# Output the results to a new CSV file
output_df = df[['train_id', 'time_to_poi', 'predicted_time_to_poi']]
output_df.to_csv('prediction.csv', index=False)

print("Model saved as 'model.pkl' and predictions saved as 'prediction.csv'")
