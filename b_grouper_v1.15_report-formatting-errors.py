        ...
        for file in new_files:
            ...
            if os.path.isfile(file_path):
                try:
                    ...
                    print(f"File '{file}' is empty or has no columns to parse. Skipping file.")
                    continue  # Skip this file and move to the next one

                if "line" in df.columns:
                    train_line_rows = df[df["line"].str.contains(train_line, case=False, na=False)].copy()
                    if not train_line_rows.empty:
                        ...
                        try:
                            ...
                            print(f"Error processing file '{file}': {e}. File skipped.")
                            continue  # Skip this file and move to the next one
